...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('img/swagger-favicon-32x32.png')}}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{asset('img/swagger-favicon-16x16.png')}}" sizes="16x16" />
    <style>
        html
        {
